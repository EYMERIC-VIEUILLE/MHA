...
public class MHABot {
	...
	private void frappe()
	{
			...
			try
		{
				...
				//SI j'ai 6PA et que je n'attaque qu'à 4PA et que je suis darkling, j'ai une chance de renverser le troll adverse si ma déstabilisation est superieure a l'agilite de l'adversaire
