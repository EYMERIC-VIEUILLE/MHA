			...
			try
			{
				...
				if(!smallbmm)
				{
					...
					for(int i=19;i<liste.length;i++)
						nomEquip+=" "+liste[i];
					Equipement equip = new Equipement(idEquip, nomEquip, typeEquip, attEquip, esqEquip, degEquip,
							dlaEquip, regEquip, vueEquip, pvEquip, apEquip, amEquip, mmEquip, rmEquip, zoneEquip,
							dropEquip, poidsEquip, isEquipped);
					t.addEquipement(equip);
					caracTrolls.set(myIndex,caracTrolls.get(myIndex)+inputLine+"\n");
					if(liste[17].equals("1"))
						t.equipe(equip);
				...
				else
				{
					...
					for(int i=21;i<liste.length;i++)
						nomEquip+=" "+liste[i];
					Equipement equip = new Equipement(idEquip, nomEquip, typeEquip, attEquip, attMEquip, esqEquip,
							degEquip, degMEquip, dlaEquip, regEquip, vueEquip, pvEquip, apEquip, amEquip, mmEquip,
							rmEquip, zoneEquip, dropEquip, poidsEquip, isEquipped);
					t.addEquipement(equip);
					caracTrolls.set(myIndex,caracTrolls.get(myIndex)+inputLine+"\n");
					if(liste[19].equals("1"))
						t.equipe(equip);
