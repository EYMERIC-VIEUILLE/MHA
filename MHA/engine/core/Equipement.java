...
public class Equipement {
	...
	public Equipement(int i, String n, int t, int a, int e, int d, int dla, int r, int vue, int pv, int ap, int am,
			int bmm, int brm, boolean g, boolean dr, int p, final boolean isEquipped) {
		id=i;
		name = n;
		type=t;
		bmAttaque=a;
	...
	public Equipement(int i, String n, int t, int a, int bam, int e, int d, int dm, int dla, int r, int vue, int pv,
			int ap, int am, int bmm, int brm, boolean g, boolean dr, int p, final boolean isEquipped) {
		this(i, n, t, a, e, d, dla, r, vue, pv, ap, am, bmm, brm, g, dr, p, isEquipped);
		bmmAttaque=bam;
		bmmDegat=dm;
	}

	public Equipement(int i, String n, int t, int a, int bam, int e, int em, int d, int dm, int dla, int r, int rem,
			int vue, int vuem, int pv, int ap, int am, int bmm, int brm, boolean g, boolean dr, int p,
	...
	/**
	 * Indicates if the equipment is brought by the troll or is in the bag.
	 *
	 * @return <code>true</code> if the equipment is brought by the troll.
